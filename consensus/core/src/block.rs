...
///　追加(10/02)
///　- To KHU
///　9月に荷物が届いたのですが、家に2つの牛乳BOXが届いていないそうです。
///　9月にRCHIが荷物を受け取る際に回収された品物がないか確認していただけますか？
///  ＞＞　RCHIにも確認しましたが、回収されたことはないそうです。
///　HSMとの連携は直接できず、他の人に依頼しますか？例えば、RGHの方で確認して結果を受け取るという形ですか？
///　＞＞　今まで直接連絡していました。今回は連絡が取れないですが、何の問題があるかは良く分かりません。（一つの番号は電源OFF、一つは信号は行きますが、受けていません）
///　- To YeSongママ
