...
/// 
/// --- ご確認お願いします。
/// 11月にPYに入ると聞きましたが、いつ入る予定ですか？そしてこれからはまたRaSonに出ないんですか？
/// →　はい、11月明けに撤収予定です。RSには出ないと思います。
/// 
/// --- YeSongママに下記の内容を伝えてください。
/// 1. 10月にJuOk姉さん（England）が祖国に帰ったのに手紙を受け取ったか確認して返事を送ってください。そして、JuOk姉さんからもらう148$がありますが、もらって結果を教えてください。
/// 　→　JuOkさんから手紙は受け取りました。148$もお母さんが受け取りました。（以下、YeSongパパに確認しました。）
/// 　　　工具は高いですので、購入しないでください。
/// 　　　門サイズやタイル購入などに関しては私（YeSongパパ）が出国して電話します。（早ければ１１月末頃に出国予定、出国日が決まったら連絡する）
/// 　　　私が出国したらタイル運搬などを組織する人もいなくなりますので、可能であればMiryongママが帰国する際に持って来るのが良さそうだと思う。
/// 　　　タイルなど建材品が国内にも高級があり、運搬などを考えると国内で購入することも良いですので、良く考えてみてください。
/// 2. 9月に送ったエアコン1台(Haier)は兄さんに渡したか確認を願います。
/// 　→　渡して設置してくれました。（Haierエアコン）
/// 3. 9月に送ったエアコン(Media 2台)は我が家に設置した状態ですか？それとも部屋の中に置いた状態ですか？送った冷凍機ももらって家に置いてあるか確認してください。
/// 　→　Mideaエアコン２台、冷蔵庫１台を部屋の中に置いた状態です。その他のものも全部触らず家に置きました。
/// 　　　作業が終わらなかったので、設置はできない状態です。
/// 
