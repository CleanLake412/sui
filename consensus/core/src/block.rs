...
/// 　以前の内容に対して回答をお願いします。
/// 
/// ・YeSongママから家の手入れに対して長文の内容を送ってきました。
/// 　内容はまとめますが、先に伝えることは２点です。（もし家を再度選ぶことになると、多い内容は不要になります）
/// 　→　Miryongのお祖母さんの意見は、条件が満たすのであれば帰国してから良い新家を選ぶのが良いのではないかと言うことです。
/// 　→　もし今の家を手入れする場合、暖房工事を含めて早めに開始しないといけません。
/// 　　　打ち合わせした通り開始して問題ないか結論を出してください。
/// 
