...
/// 　トイレ 80  *200
/// 　出入ドア　90 * 210
/// 　ベランダのドアは国内で制作した方が良さそうです。（ガラスが壊れる恐れがある）
/// 　頼んだ通り全部潰しておく
/// ２．出入ドアは我々のようにした方が良い
/// ３．部屋：　ベート、TV掛け、壁紙など
/// ４．家具
/// 　家具は太い建具板を購入してきて部屋のサイズを考慮して国内で制作した方が良い。
/// 　大きい部屋、小さい部屋、廊下、台所まで考慮して太い建具板を色別に購入して送ってください。
/// 　ドアの取っ手、やり戸ロラー、蝶番など家具制作に必要な付属品を全部送ってほしいです。
/// ５．台所
/// 　ガスコンロ、厨房鼓风机、ガシ台、水道の栓など
/// 　設備が決まったらそれに合わせて骨造を決めれば良い
/// ６．トイレ
/// 　倉庫を拡張してトイレを大きくするべき
/// 　水加熱機、パンプ、ミラー、水道の栓、シャワー室の一式など
/// ７．バリケットは使わない方が良い
/// ８．大体の予算
/// 　潰し、汚物処理、荷物運搬、壁紙作業の前の壁美装とスパーク作業、
/// 　暖房装置、上水工事、ガス管工事、電気工事まで努力費が800ドルぐらい、
/// 　資材費が900ドルぐらい掛かりそう。
/// 　家具制作、天井工事など乾式工事は帰国して自分の美感に合わせてやった方が良いと思う。
/// 
/// その家に決めて工事を開始するか、新家に引っ越しをするか正確に決心してほしい。
/// もっと広い新家を購入して手入れをすることも可能。もちろん費用は比較的に高くなる。
/// 
/// 税関を通過することに気を付けてください。
/// レンジのように電気使用が多い設備は回収処分される。
/// 中央暖房工事をしないといけないため、工事を始めるにはすぐ開始する必要がある。
/// 決心が立てたら教えて下さい。
